...
class TeleopJoy {
	...
	private:
		...
		//New
		ros::Publisher body_cmd_pub = node.advertise<crab_msgs::BodyCommand>("/teleop/body_command",1) ;
		...
		const static int button_triangle_switch = PS3_BUTTON_ACTION_TRIANGLE;
    	const static int button_circle_switch = PS3_BUTTON_ACTION_CIRCLE;  
    	const static int button_square_switch = PS3_BUTTON_ACTION_SQUARE;         	       	
